...
export const LIZ_EMAIL = 'lizneyr@americana.edu.co';            // Liz
...
export const NOTIF_BASE: Record<string, string[]> = {
  // Gestor
  enviado:   [CGC_EMAIL, CDI_EMAIL, LIZ_EMAIL],
  corregido: [CGC_EMAIL, CDI_EMAIL, LIZ_EMAIL], // + DI responsable del curso
  // DI
  aprobado:  [CGC_EMAIL, CDI_EMAIL, LIZ_EMAIL], // + Gestor responsable del curso
